...
OUTPUT_FILENAME = "test_olive_pure_baseline_v1_field.geojson"
...
def main():
    ...
    WITH src AS (
        ...
        ORDER BY spectral_flag ASC, compactness DESC, area_ha ASC
        LIMIT 1
    ),
    point_inside AS (
        SELECT
    ...
    feature_collection = {
        ...
        "name": "test_olive_pure_baseline_v1_field",
        "features": [
            {
                "type": "Feature",
                "properties": {
                    "name": "Test oliveto puro baseline v1",
                    "source": "landcover_olive_pure_baseline_v1",
    ...
    print("Source: landcover_olive_pure_baseline_v1")
